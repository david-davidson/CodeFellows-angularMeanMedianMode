...
},{"./../bower_components/angular/angular":5,"./mmmController":2,"./mmmDirective":3,"./mmmService":4}],2:[function(require,module,exports){
'use strict';
...
},{"../lib/meanMedianMode":6}],5:[function(require,module,exports){
/**
...
/**
 * Accepts an array of one or more numbers and returns
 * their mean
 *
 * @param {Array} numbers
...
describe('The math controller', function() {
  ...
  it('should calculate median', function() {
    expect(results[1].name).toEqual('meddian');
...
},{"../app/app.js":1,"angular-mocks":7}]},{},[8]);
